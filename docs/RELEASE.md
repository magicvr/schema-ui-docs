...
|---|---|---|---|
| `v<artifactVersion>` 如 `v2.1.0` | 根 `package.json` / `protocol-manifest.json` | `.github/workflows/protocol-release.yml` | GitHub Release：`schema-ui-protocol-*.tar.gz` + `.sha256` |
