...
meta:            # 页面元信息
  ...
  requiredCapabilities: [string] # 可选（since 0.2.6）。执行能力协商，如 actions.page.trigger / table.selection / permissions.inheritance / record.view.load / table.sort / app.manifest
