...
| [13-v2.2-release-goals.md](./13-v2.2-release-goals.md) | 前后端开发者 / 维护者 | `v2.2.0` 当前 MINOR 发布目标与门禁 |
...
- 维护或发布 `v2.2.0` → 对照 `13-v2.2-release-goals.md`；`12` / `10` / `09` 为历史发布证据。
- 规划权限继承等后续 Admin 能力 → 读 `11-next-admin-lifecycle-goals.md`；P0/P1 选择批量见 ADR-0020 / 0021 / 0022。
