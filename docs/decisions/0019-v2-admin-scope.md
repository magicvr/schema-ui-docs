...
P0 已接受（capability 门控；无新字段的 v2.0 页面不受影响）：

- [`0020-page-action-trigger.md`](./0020-page-action-trigger.md) — 页面级 ActionTrigger / 表格工具栏；
- [`0021-record-navigation-and-form-load.md`](./0021-record-navigation-and-form-load.md) — 行级 navigate、`$context.route`、form 记录加载回填。
