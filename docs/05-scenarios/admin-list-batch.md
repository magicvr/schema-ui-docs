...
> **版本说明（V275）：** 在 `2.2.0` 制品 tag 前，示例使用 `protocolVersion: "2.1"` + capability 协商。正式发布后升至 `"2.2"`（见 [13-v2.2-release-goals.md](../13-v2.2-release-goals.md) 与 [migrations/2.1-to-2.2.md](../migrations/2.1-to-2.2.md)）。
