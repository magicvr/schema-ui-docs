...
> **版本说明：** 本扩展示例使用 `protocolVersion: "2.5"` 与 batch capabilities（见 [release-goals/v2.2.md](../release-goals/v2.2.md) 与 [migrations/2.1-to-2.2.md](../migrations/2.1-to-2.2.md)）。
