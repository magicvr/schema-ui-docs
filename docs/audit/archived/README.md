...
**性质：** 1×P1 + 4×P2 in-repo 全部关闭；3×P3（V391–V393）登记为后续候选不改本轮。主类型=消费边界审计；次类型=实现/契约漂移。

| 文件 | 说明 |
|---|---|
| [0081-2026-08-13-review.md](./0081-2026-08-13-review.md) | 审计报告 — V386–V393（P1/P2 关闭，P3 候选登记） |
| [0081-2026-08-13-checklist.md](./0081-2026-08-13-checklist.md) | 跟踪清单 — ADR-0038、修订、2.8.2 身份与门禁 |
...
| 文件 | 说明 |
|---|---|
| [0079-2026-08-13-review.md](./0079-2026-08-13-review.md) | 审计报告 — V375–V378 与 A-002 |
| [0079-2026-08-13-checklist.md](./0079-2026-08-13-checklist.md) | 跟踪清单 |

**关闭证据（0079 当时记录，不改写）：** 消费者 P2 已修；A-002 `BLOCKING_COUNT=0`。正式 pin 以 0080 核对的 tag `521cff8` / content `4fae4605…` / artifact `6cdbffcc…` 为准。
...
**性质：** 2×P2 + 1×P3 **全部关闭**。主类型=实现/契约漂移（发布后入口/门禁卫生）。

| 文件 | 说明 |
|---|---|
| [0075-2026-07-28-review.md](./0075-2026-07-28-review.md) | 审计报告 — V359–V361（全部关闭） |
| [0075-2026-07-28-checklist.md](./0075-2026-07-28-checklist.md) | 跟踪清单 — 修复与归档门禁 |

**关闭证据：**

| 项 | 结果 |
|---|---|
| V360 | `release-check` 纳入 `form-controls-extended.md`；场景 README 补门禁说明 |
| V359 | `00-overview` §5 交付段 + 场景覆盖写入 ADR-0028 / 2.6.0 |
| V361 | CHANGELOG `v2.5.3` 指针改为见 **v2.6.0** |
| 本地门禁 | `check:links`、`release:check`（303；fixture `3a9cd233…`）、`validate:scenarios` 绿 |
| 发布 | **不**强制 PATCH；**未**改写 `v2.6.0` / `mcp-v2.6.0` |

**说明：** 修复后工作树 content/artifact 与正式 `v2.6.0` 因 informative 文档分叉；fixture 不变。生产消费者仍 pin `v2.4.1`（out-of-repo）。
...
| 文件 | 说明 |
|---|---|
| [0071-2026-07-28-review.md](./0071-2026-07-28-review.md) | 审计报告 — V336–V344（全部关闭） |
| [0071-2026-07-28-checklist.md](./0071-2026-07-28-checklist.md) | 跟踪清单 — 修复、2.5.1 发布与归档门禁 |

**关闭证据：**

| 项 | 结果 |
|---|---|
| V336–V343 | 双语言 reference/fixtures、M3a、基址语义、Schema、MCP 文档/根目录、场景 release gate 与 Docker context 均闭合；292 cases、35 conformance 入口、134 MCP tests 通过 |
| V344 | PR [#26](https://github.com/magicvr/schema-ui-docs/pull/26) → `main` `6191c14`；tag `v2.5.1` Protocol Release [30308927470](https://github.com/magicvr/schema-ui-docs/actions/runs/30308927470) success；tag `mcp-v2.5.1` MCP CD [30309020148](https://github.com/magicvr/schema-ui-docs/actions/runs/30309020148) success |
| 正式资产 | protocol artifact `sha256:3524c527…`；fixture `712f6c42…`；content `3a20f417…`；MCP 镜像 `sha256:bc16dc34…`（`2.5.1` / SHA / `2.5` / `latest` 同 digest，label 协议 2.5.1） |

**说明：** 未改写 `v2.5.0` / `mcp-v2.5.0`。生产消费者升级继续作为 out-of-repo 跟踪。
...
**性质：** 3 项 P1 + 6 项 P2 全部关闭；`2.2.0` 制品 tag 按 `release-goals/v2.2` 择机。
