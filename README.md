...
当前协议版本为 `2.1.0`，页面声明使用 `meta.protocolVersion: "2.1"`。
...
```text
dist/schema-ui-protocol-2.1.0.tar.gz
dist/schema-ui-protocol-2.1.0.tar.gz.sha256
...
当前跨实现消费规则与 fixture 分类见 [`conformance/README.md`](./conformance/README.md)。从 `2.0` 升级到
`2.1` 请按 [`docs/migrations/2.0-to-2.1.md`](./docs/migrations/2.0-to-2.1.md) 执行；从 `1.0` 请先按
[`docs/migrations/1.0-to-2.0.md`](./docs/migrations/1.0-to-2.0.md)。
...
`scripts/` 提供 L0/L1、L2、L3a、L4 校验实现。当前 validator 版本为 `1.0.0`，支持协议制品 `2.1.0`，
